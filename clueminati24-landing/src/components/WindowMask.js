...
const WindowMask = () => {
  ...
  return (
    ...
    //     className="mask-content one flex flex-col justify-center items-left gap-[8rem] py-16 px-36 h-[100vh]  text-grey bg-green"
    //   >
    // <motion.div
    //   animate={{
    //     WebkitMaskPosition: `${x - size / 2}px ${
    ...
    // >
    <div className="flex flex-col justify-center items-left gap-[8rem] py-16 px-36 h-[100vh] relative cursor-default text-grey bg-green">
      {/* <motion.div
        className="mask-content flex flex-col justify-center items-left gap-[8rem] py-16 px-36 h-[100vh]  text-grey bg-green"
      > */}
      <p
        onMouseEnter={() => {
